...
@Component({
	...
	selector: 'zoom-lens-image',
	templateUrl: './zoom-lens-image.component.html',
	styleUrls: ['./zoom-lens-image.component.css']
})
export class ZoomLensImageComponent implements OnInit {
